...
export const ShopCatalog: React.FC = () => {
  ...
  if (loading) return <div className="text-center py-12">Loading store catalog...</div>;
  if (error) return <div className="text-center py-12 text-red-500">{error}</div>;

  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Store Catalog</h1>

      {products.length === 0 ? (
        <p className="text-gray-500">No products available in store right now.</p>
      ) : (
