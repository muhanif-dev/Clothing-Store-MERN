...
export const LatestCollections: React.FC = () => {
  ...
  useEffect(() => {
    const fetchLatest = async () => {
      try {
        ...
        // Slice first 8 products as latest arrivals
  ...
  if (loading) return <div className="text-center py-8">Loading latest collections...</div>;

  return (
    <div id="latest" className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center py-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">LATEST COLLECTIONS</h2>
        <p className="text-gray-500 max-w-xl mx-auto text-sm">
          Explore our newly added styles, tailored with precision and designed to stand out.
        </p>
      </div>
